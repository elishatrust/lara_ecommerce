...
<main class="main">
    ...
    <div class="container">
        <div class="page-header page-header-big text-center" style="background-image: url('{{ url('public/assets-front/images/contact-header-bg.jpg') }}')">
                            ...
                            <div class="row">
                                <div class="col-sm-5 col-xl-6">
                                    <figure class="store-media mb-2 mb-lg-0">
                                        <img src="{{ url('public/assets-front/images/stores/img-1.jpg') }}" alt="image">
                    ...
                    <div class="col-lg-6">
                        <div class="store">
                            <div class="row">
                                <div class="col-sm-5 col-xl-6">
                                    <figure class="store-media mb-2 mb-lg-0">
                                        <img src="{{ url('public/assets-front/images/stores/img-2.jpg') }}" alt="image">
                                    </figure><!-- End .store-media -->
                                </div><!-- End .col-xl-6 -->
