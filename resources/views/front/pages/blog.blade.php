...
<main class="main">
    <div class="page-header text-center" style="background-image: url('{{ url('public/assets-front/images/page-header-bg.jpg') }}')">
        <div class="container">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-5">
                                <figure class="entry-media">
                                    <a href="single.html">
                                        <img src="{{ url('public/assets-front/images/blog/listing/post-1.jpg') }}" alt="image desc">
                                    </a>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-5">
                                <figure class="entry-media entry-video">
                                    <a href="single.html">
                                        <img src="{{ url('public/assets-front/images/blog/listing/post-2.jpg') }}" alt="image desc">
                                    </a>
                                </figure><!-- End .entry-media -->
                            </div><!-- End .col-md-5 -->
                            ...
                            <div class="col-md-5">
                                <figure class="entry-media">
                                    <div class="owl-carousel owl-simple owl-light owl-nav-inside" data-toggle="owl">
                                        <a href="single.html">
                                            <img src="{{ url('public/assets-front/images/blog/listing/post-3.jpg') }}" alt="image desc">
                                        </a>
                                        <a href="single.html">
                                            <img src="{{ url('public/assets-front/images/blog/listing/post-1.jpg') }}" alt="image desc">
                                        </a>
                    ...
                    <article class="entry entry-list">
                        <div class="row align-items-center">
                            <div class="col-md-5">
                                <figure class="entry-media">
                                    <a href="single.html">
                                        <img src="{{ url('public/assets-front/images/blog/listing/post-4.jpg') }}" alt="image desc">
                                    </a>
                                </figure><!-- End .entry-media -->
                            </div><!-- End .col-md-5 -->
                    ...
                    <article class="entry entry-list">
                        <div class="row align-items-center">
                            <div class="col-md-5">
                                <figure class="entry-media">
                                    <a href="single.html">
                                        <img src="{{ url('public/assets-front/images/blog/listing/post-5.jpg') }}" alt="image desc">
                                    </a>
                                </figure><!-- End .entry-media -->
                            </div><!-- End .col-md-5 -->
                    ...
                    <article class="entry entry-list">
                        <div class="row align-items-center">
                            <div class="col-md-5">
                                <figure class="entry-media">
                                    <a href="single.html">
                                        <img src="{{ url('public/assets-front/images/blog/listing/post-6.jpg') }}" alt="image desc">
                                    </a>
                                </figure><!-- End .entry-media -->
                            </div><!-- End .col-md-5 -->
                    ...
                    <div class="sidebar">
                        ...
                        <div class="widget">
                            ...
                            <ul class="posts-list">
                                <li>
                                    <figure>
                                        <a href="#">
                                            <img src="{{ url('public/assets-front/images/blog/sidebar/post-1.jpg') }}" alt="post">
                                        </a>
                                    </figure>
                                ...
                                <li>
                                    <figure>
                                        <a href="#">
                                            <img src="{{ url('public/assets-front/images/blog/sidebar/post-2.jpg') }}" alt="post">
                                        </a>
                                    </figure>
                                ...
                                <li>
                                    <figure>
                                        <a href="#">
                                            <img src="{{ url('public/assets-front/images/blog/sidebar/post-3.jpg') }}" alt="post">
                                        </a>
                                    </figure>
                                ...
                                <li>
                                    <figure>
                                        <a href="#">
                                            <img src="{{ url('public/assets-front/images/blog/sidebar/post-4.jpg') }}" alt="post">
                                        </a>
                                    </figure>
                        ...
                        <div class="widget widget-banner-sidebar">
                            ...
                            <div class="banner-sidebar banner-overlay">
                                <a href="#">
                                    <img src="{{ url('public/assets-front/images/blog/sidebar/banner.jpg') }}" alt="banner">
                                </a>
                            </div><!-- End .banner-ad -->
                        </div><!-- End .widget -->
